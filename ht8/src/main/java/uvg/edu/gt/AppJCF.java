...
/**
 * Versión alternativa de la aplicación que usa la implementación
 * PriorityQueue del Java Collections Framework.
 */
public class AppJCF {
    ...
    public static void main(String[] args) {
        System.out.println("Sistema de Atención de Pacientes de Emergencia (JCF)");
        System.out.println("----------------------------------------------------");

        // Crear la cola de prioridad con la implementación de Java
